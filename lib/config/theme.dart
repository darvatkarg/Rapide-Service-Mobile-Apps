...
class AppTheme {
  ...
  static ThemeData lightTheme = ThemeData(
    ...
    colorScheme: ColorScheme.light(
      ...
      onTertiary: bottomNavSelectedColor,
    ),
    ...
    // ── Suppress all SnackBars ──
    snackBarTheme: const SnackBarThemeData(
      backgroundColor: Colors.transparent,
      elevation: 0,
      contentTextStyle: TextStyle(fontSize: 0, height: 0, color: Colors.transparent),
      behavior: SnackBarBehavior.fixed,
    ),

    // ── Hide form validation error text ──
    inputDecorationTheme: const InputDecorationTheme(
      errorStyle: TextStyle(fontSize: 0.01, height: 0.01, color: Colors.transparent),
    ),
