...
class ApiRoutes {
  ...
  static String createParcelApi = '${AppConstant.baseUrl}user/parcels/create';
  static String getOngoingParcelsApi =
      '${AppConstant.baseUrl}user/parcels/ongoing';
  static String getParcelsHistoryApi =
      '${AppConstant.baseUrl}user/parcels/history';
  ...
  static String parcelOrderDetailApi = '${AppConstant.baseUrl}user/parcels/';
  ...
  static String intercitiesApi = '${AppConstant.baseUrl}intercities';
}
