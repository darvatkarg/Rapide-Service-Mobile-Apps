...
abstract class AppLocalizations {
  ...
  ///
  /// In en, this message translates to:
  /// **'Fresh Groceries Just A Click Away!'**
  String get freshGroceries;

  /// No description provided for @discoverAmazing.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @sendHeartfelt.
  ///
  /// In en, this message translates to:
  /// **'Send heartfelt presents, right on time'**
  String get sendHeartfelt;

  /// No description provided for @fromIDs.
  ///
  /// In en, this message translates to:
  /// **'From IDs to forms, we deliver it all'**
  String get fromIDs;

  /// No description provided for @safeguard.
  ///
  /// In en, this message translates to:
  /// **'Safeguard your gadgets with secure delivery'**
  String get safeguard;

  /// No description provided for @smallOrLarge.
  ///
  /// In en, this message translates to:
  /// **'Small or large packages delivered fast'**
  String get smallOrLarge;

  /// No description provided for @whtu.
  ///
  /// In en, this message translates to:
  /// **'What would you like to send?'**
  String get whtu;

  /// No description provided for @parcelLocation.
  ///
  /// In en, this message translates to:
  /// **'Parcel Location'**
  ...
  /// No description provided for @parcelRequest.
  ///
  /// In en, this message translates to:
  /// **'Parcel Request'**
  String get parcelRequest;
  ...
  /// No description provided for @confirmParcelRequest.
  ///
  /// In en, this message translates to:
  /// **'Confirm Parcel Request'**
  String get confirmParcelRequest;

  /// No description provided for @whoWillPay.
  ///
  /// In en, this message translates to:
  /// **'Who will pay?'**
  String get whoWillPay;
  ...
  /// No description provided for @orderNearestDelivery.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @deliveryCityToCity.
  ///
  /// In en, this message translates to:
  /// **'Delivery from one city to another city'**
  String get deliveryCityToCity;
  ...
  /// No description provided for @productNotApproved.
  ///
  /// In en, this message translates to:
  ...
  ///
  /// In en, this message translates to:
  /// **'Fast and secure delivery for all your needs'**
  String get fastSecure;

  /// No description provided for @returnReceivedWarehouse.
  ///
  /// In en, this message translates to:
  /// **'Return received at warehouse. Processing your refund...'**
  String get returnReceivedWarehouse;

  /// No description provided for @refundedSuccessfully.
  ///
  /// In en, this message translates to:
  /// **'refunded successfully!'**
  String get refundedSuccessfully;

  /// No description provided for @returnRequestRejected.
  ///
  /// In en, this message translates to:
  /// **'Return request rejected by seller'**
  String get returnRequestRejected;

  /// No description provided for @returnRequestCancelled.
  ///
  /// In en, this message translates to:
  /// **'Return request has been cancelled.'**
  String get returnRequestCancelled;
  ...
  /// No description provided for @helpUsUnderstandExperience.
  ///
  /// In en, this message translates to:
  /// **'Help us understand your experience'**
  ...
  /// No description provided for @selectReceiverAddress.
  ///
  /// In en, this message translates to:
  /// **'Select receiver address'**
  String get selectReceiverAddress;

  /// No description provided for @pleaseSelectReceiverAddress.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @parcelCreatedMessage.
  ///
  /// In en, this message translates to:
  /// **'Parcel {parcelId} created'**
  ...
  /// No description provided for @parcelStatusUpdatedMessage.
  ///
  /// In en, this message translates to:
  /// **'Parcel {parcelId} updated to {status}'**
