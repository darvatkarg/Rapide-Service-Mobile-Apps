...
class _CartPageState extends State<CartPage> {
                                ...
                                return Column(
                                  children: [
                                    ...
                                    BillSummaryWidget(
                                      ...
                                      itemsDiscountedPrice: billSummaryData!
                                              .itemsTotal
                                              ?.toDouble() ??
                                          0,
                                      itemsSavings: 0,
                                      deliveryChargeOriginal: billSummaryData
                                      ...
                                      handlingCharge: billSummaryData
                                              ...
                                              ?.toDouble() ??
                                          0,
                                      grandTotal: billSummaryData.payableAmount
                                              ?.toDouble() ??
                                          0,
                                      totalSavings: 0,
  ...
  void _handleAddMoreItems() {
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
          content: Text(l10n?.addMoreItemsTapped ?? 'Add more items tapped!')),
    );
  }
                      ...
                      onPressed: isCartLoading
                          ...
                          : () {
                              ...
                              final cartValidationError =
                                ...
                                totalItemsCount:
                                    stateData.first.data!.totalQuantity!,
                                storeIds: storeIds,
                              );
