...
class _DeliveryTrackingPageState extends State<DeliveryTrackingPage> {
          ...
          if(state is OrderDelivered) {
            ...
            GoRouter.of(context).push(
              ...
              extra: {
                ...
                'addressType': _currentTracking!.data!.order!.shippingAddressType,
  ...
  Widget _buildDeliveryDetailsSection({required List<RouteDetail> stops, required String destTitle, required String destSubtitle,}) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Padding(
