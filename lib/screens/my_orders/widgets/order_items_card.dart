    ...
    return Container(
      ...
      child: Row(
        ...
        children: [
          ...
          Text(
            '${items.length} ${items.length == 1 ? (l10n?.product ?? 'Product') : (l10n?.products ?? 'Products')}',
            style: TextStyle(
  ...
  Widget _buildPriceSection(OrderItems item, BuildContext context) {
    return SizedBox(
      ...
      child: Column(
        ...
        children: [
          Text(
            '${AppHelpers.currency}${((item.quantity)! * (double.parse(item.price.toString()))).toInt()}',
            style: TextStyle(
              fontSize: isTablet(context) ? 18 : 12.sp,
              fontWeight: FontWeight.w600,
              fontFamily: AppTheme.fontFamily,
        ...
        children: [
          ...
          Row(
            children: [
              ...
              SizedBox(width: 6.w),
              Text(
                '${l10n?.attachments ?? 'Attachments'} (${allUrls.length})',
                style: TextStyle(
                  fontSize: 13.sp,
                  fontWeight: FontWeight.w600,
