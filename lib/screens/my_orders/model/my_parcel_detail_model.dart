...
class Parcel {
  ...
  final String? senderLong;
  final String? senderStreet;
  final String? senderHouse;
  ...
  factory Parcel.fromJson(Map<String, dynamic> json) {
    return Parcel(
      ...
      receiverHouse: json['rc_house'],
      receiverFloor: json['rc_floor'],
      senderName: json['sd_name'],
      senderEmail: json['sd_email'],
      senderMobile: json['sd_mobile'],
      senderAddress: json['sd_address'],
      senderLat: json['sd_lat'],
      senderLong: json['sd_long'],
      senderStreet: json['sd_street'],
      senderHouse: json['sd_house'],
      senderFloor: json['sd_floor'],
      whoPay: json['pb_whoPay'],
      payMethod: json['pb_payMethod'],
      deliveryCharge: json['pb_deliveryCharge'],
      status: json['pb_status'],
  ...
  Map<String, dynamic> toJson() => {
        ...
        'rc_floor': receiverFloor,
        'sd_name': senderName,
        'sd_email': senderEmail,
        'sd_mobile': senderMobile,
        'sd_address': senderAddress,
        'sd_lat': senderLat,
        'sd_long': senderLong,
        'sd_street': senderStreet,
        'sd_house': senderHouse,
        'sd_floor': senderFloor,
        'pb_whoPay': whoPay,
        'pb_payMethod': payMethod,
        'pb_deliveryCharge': deliveryCharge,
        'pb_status': status,
...
class Address {
  ...
  final String? zipcode;
  final dynamic
      latitude; // Changed to dynamic to handle high precision doubles from JSON
