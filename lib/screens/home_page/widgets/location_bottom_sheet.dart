...
class _LocationBottomSheetState extends State<LocationBottomSheet>
  ...
  Future<void> _searchPlaces(String query) async {
    ...
    try {
      ...
      final response = await dio.get(
        ...
        options: Options(
          headers: {
            'Referer': AppConstant.packageName,
          },
        ),
      );
      ...
      if (response.statusCode == 200) {
        ...
        if (data['status'] == 'OK') {
          ...
          final String formattedAddress =
              data['result']['formatted_address'] ?? address;
  ...
  void _useCurrentLocation() {
    log('EHHHEEELLL ${AppHelpers.defaultLng}');
  ...
  void _showErrorSnackBar(String message) {
    ToastManager.show(
        context: context, message: message, type: ToastType.error);
  }
          ...
          child: Container(
            ...
            child: Column(
              children: [
                ...
                if (AppHelpers.isDemo) demoModeLocationNote(),
                // SizedBox(height: 12,),
          ...
          children: [
            ...
            InkWell(
              onTap: () {
                GoRouter.of(context).push(
                  AppRoutes.locationPicker,
                  extra: {'isFromAddressPage': true, 'isEdit': false},
                );
              },
              borderRadius: BorderRadius.only(
