...
if (state.addressList.isEmpty) {
  return Center(
    child: const Text("No saved addresses"),
  );
}
                      ...
                      child: InkWell(
                        onTap: () async {
                          ...
                          if (latitude == null || longitude == null) {
                           ...
                           await SecureStorageHelper.saveSelectedAddressId(address.id!);
                          ...
                          onPressed: isRemoving
                            ...
                            context.read<GetAddressListBloc>().add(
                              RemoveAddressRequest(addressId: address.id!),
                               ...
                               box.delete('user_location');
                                  print('Deleted stored location from Hive###############');
                          },
                          child: isRemoving
                              ? SizedBox(
                            width: 16,
