...
class _RegisterPageState extends State<RegisterPage> {
  ...
  void _phoneNumberAuthentication() async {
    print("Starting phone number authentication...");
  ...
  Widget _buildPasswordMatchDots() {
    ...
    return Padding(
      padding: EdgeInsets.only(left: 48.w), // Align with text after prefix icon
      child: Wrap(
        spacing: 6,
        runSpacing: 4,
        children: List.generate(password.length, (index) {
          Color dotColor = Colors.grey[300]!; // Default: not yet entered
