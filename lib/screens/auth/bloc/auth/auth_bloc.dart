...
final standardCharge =
    response.first.standardDeliveryCharge ?? 0;
    print('Standard Delivery Charge: $standardCharge');
    await SecureStorageHelper.saveStandardDeliveryCharge(
    standardCharge.toString());
        ...
        _userDetailBloc.add(SetUserData(UserDataModel(
          ...
          language: 'en',
          standardDeliveryCharge: userData.standardDeliveryCharge ?? 0.0,
        )));
    ...
    try {
      ...
      if (response['success'] == false &&
        ...
        _userDetailBloc.add(SetUserData(UserDataModel(
          ...
          language: 'en',
          standardDeliveryCharge: user.standardDeliveryCharge ?? 0.0,
        )));
        emit(
