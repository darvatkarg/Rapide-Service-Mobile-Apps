...
class _DeliveryZoneDetailsPageState extends State<DeliveryZoneDetailsPage> {
  ...
  void initState() {
    ...
    if (widget.zone == null) {
      context.read<DeliveryZoneBloc>().add(SelectDeliveryZoneEvent(widget.zoneId));
    }
  }
              ...
              children: [
                ...
                _buildDetailCard(
                  ...
                  items: [
                    ...
                    if (zone.rushDeliveryEnabled && zone.rushDeliveryCharges != null)
                      _DetailItem(
                        label: 'Rush Delivery',
  ...
  Widget _buildMap(DeliveryZoneModel zone) {
    ...
    final centerLat = double.tryParse(zone.centerLatitude) ?? 0.0;
    final centerLng = double.tryParse(zone.centerLongitude) ?? 0.0;
    final center = LatLng(centerLat, centerLng);

    // Convert boundary points to LatLng
    final List<LatLng> boundaryPoints = zone.boundaryJson
