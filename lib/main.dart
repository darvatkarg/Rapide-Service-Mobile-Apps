  ...
  Widget build(BuildContext context) {
    return MultiBlocProvider(
      providers: [
        ...
        BlocProvider(create: (context) => ParcelCreateBloc()),
      ],
                    ...
                    child: SafeArea(
                      ...
                      child: MaterialApp.router(
                        ...
                        locale: languageState is LanguageLoaded
                            ...
                            : const Locale('en'),
                        // Suppress all SnackBars / error banners globally
                        builder: (context, child) {
                          return _SilentScaffoldMessenger(
...
/// Wraps its child in a [ScaffoldMessenger] that silently swallows
/// every [SnackBar] and [MaterialBanner] shown anywhere in the app.
class _SilentScaffoldMessenger extends StatefulWidget {
  const _SilentScaffoldMessenger({required this.child});
  final Widget child;

  @override
  State<_SilentScaffoldMessenger> createState() =>
      _SilentScaffoldMessengerState();
}

class _SilentScaffoldMessengerState extends State<_SilentScaffoldMessenger> {
    ...
    return ScaffoldMessenger(
      ...
      child: Builder(
        builder: (innerContext) {
          // After the first frame, override the ScaffoldMessenger so every
          // showSnackBar / showMaterialBanner call is silently ignored.
          WidgetsBinding.instance.addPostFrameCallback((_) {
            _key.currentState?.clearSnackBars();
            _key.currentState?.clearMaterialBanners();
          });
          return widget.child;
        },
      ),
