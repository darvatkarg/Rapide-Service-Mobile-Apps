...
import 'package:hyper_local/screens/parcel_confirm/view/parcel_location_page.dart';
import 'package:hyper_local/screens/parcel_confirm/view/parcel_request_page.dart';
import 'package:hyper_local/screens/parcel_confirm/view/parcel_success_page.dart';
...
class AppRoutes {
  ...
  static const String parcelSuccess = '/parcel-success';
...
class MyAppRoute {
  static GoRouter router = GoRouter(
      ...
      routes: [
              ...
              StatefulShellBranch(routes: [
                GoRoute(
                  ...
                  pageBuilder: (context, state) {
                    final extra = state.extra as Map<String, dynamic>?;
                    return platformPage(
                        HomePage(resetId: extra?['resetId'] as int?));
                  },
                ),
              ]),
              // StatefulShellBranch(routes: [
        ...
        GoRoute(
          name: 'parcel-detail',
          path: AppRoutes.parcelDetail,
          pageBuilder: (context, state) => platformPage(ParcelLocationScreen()),
        ),

        GoRoute(
          name: 'parcel-request',
          path: AppRoutes.parcelRequest,
          pageBuilder: (context, state) => platformPage(ParcelRequestScreen()),
        ),

        GoRoute(
          name: 'parcel-success',
          path: AppRoutes.parcelSuccess,
          pageBuilder: (context, state) => platformPage(ParcelSuccessScreen()),
        ),
        ...
        GoRoute(
          ...
          builder: (context, state) {
            ...
            return LocationPickerWidget(
              isFromHomePage: args?['isFromHomePage'] ?? false,
        ...
        GoRoute(
          ...
          path: AppRoutes.parcelOrderDetail,
          pageBuilder: (context, state) {
            final extra = state.extra as Map<String, dynamic>? ?? {};
            return platformPage(
              OrderDetailPage(
          ...
          pageBuilder: (context, state) {
            ...
            return platformPage(
              DeliveryTrackingPage(
                orderSlug: extra['order-slug']?.toString() ?? '',
                isParcel: extra['isParcel'] as bool? ?? false,
              ),
            );
          },
        ),
